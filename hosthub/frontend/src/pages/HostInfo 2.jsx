    ...
    return (
        <>
            <div className="text-center m-10">
                ...
                <h2 className="text-4xl">Welcome to Aunt Anna's home!</h2>
                ...
                <div className="mt-10 text-left">
                    ...
                    <p>
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Temporibus esse ut, nihil mollitia labore enim adipisci atque unde corrupti 
                        incidunt omnis veritatis fugiat quibusdam ullam perferendis harum, cum, doloremque libero?  Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
                        Temporibus esse ut, nihil mollitia labore enim adipisci atque unde corrupti incidunt omnis veritatis fugiat quibusdam ullam perferendis harum, cum, doloremque libero?
                    </p>
